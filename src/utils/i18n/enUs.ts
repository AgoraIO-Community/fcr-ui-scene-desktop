export const enUs = {
  ...
  fcr_room_label_room_id: 'Room ID:{reason1}',
  ...
  fcr_invite_label_room_id: 'Room ID {reason1}',
  fcr_invite_label_invite_link: 'Link {reason1}',
  ...
  fcr_network_label_network_latency: 'Network latency:{reason1}',
  ...
  fcr_participants_label_participants: 'Participants（Student{xxxx}）',
  ...
  fcr_participants_tips_student_rasie_hand: '{reason1}人举手,请点击查看',
