export const enUs = {
  ...
  fcr_room_button_screenshare: 'ScreenShare',
  ...
  fcr_user_tips_local_kick_out_ok: 'OK',
  ...
  fcr_online_courseware_placeholder_link: 'Please input link.',
  fcr_online_courseware_placeholder_name: 'Please input name.',
  ...
  fcr_group_unknown_username: 'The user didn‘t enter the group',
  ...
  fcr_group_confirm_ask_for_help: '{reason1} in Room {reason2} asked for help',
  ...
  fcr_group_label_broadcast_submit: 'Submit',
  ...
  fcr_cloud_tips_open_whiteboard_title: 'Open the whiteboard',
